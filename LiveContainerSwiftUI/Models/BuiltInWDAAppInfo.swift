...
final class BuiltInWDAAppInfo: LCAppInfo {
    ...
    private func ensureAndGetIconCacheFolder() -> URL? {
        let directory = LCPath.docPath
            .appendingPathComponent("WDA/Library/Caches", isDirectory: true)
            .appendingPathComponent("BuiltInWDAIconCache", isDirectory: true)
